...
class CustomerSignUpScreen extends StatefulWidget {
  ...
  @override
  State<CustomerSignUpScreen> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<CustomerSignUpScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Consumer<AuthViewModel>(builder: (context, value, child) {
        ...
        child: ButtonBig(
         ...
         value.costumerSignUpApis(phoneController.text, context);
