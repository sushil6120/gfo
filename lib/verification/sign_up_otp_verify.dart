...
class SignUpOtpVerifyScreen extends StatefulWidget {
  ...
  SignUpOtpVerifyScreen({super.key, this.arguments});

  @override
  State<SignUpOtpVerifyScreen> createState() => _LoginOtpVerifyScreenState();
}

class _LoginOtpVerifyScreenState extends State<SignUpOtpVerifyScreen> {
  String? phone;
  ...
  Widget build(BuildContext context) {
    ...
    final submittedPinTheme = defaultPinTheme.copyWith(
      decoration: defaultPinTheme.decoration!.copyWith(color: colorLightWhite),
    );
    return Scaffold(
        appBar: AppBar(
          centerTitle: true,
            ...
            return Padding(
              ...
              child: ButtonBig(
                ...
                onTap: () {
                  ...
                  value.signUpOtpVerifyApis(
                      phone.toString(), pinController.text, context);
                },
                backgroundColor: primaryColor,
