...
class RoleScreen extends StatefulWidget {
  ...
  @override
  State<RoleScreen> createState() => _RolesScreenState();
}

class _RolesScreenState extends State<RoleScreen> {
  @override
      ...
      body: SingleChildScrollView(
        child: Column(
         ...
         customeRoles("assets/user.svg", "Customer", () { 
                 Navigator.pushNamed(context, RoutesName.customerSignUpScreen);
         }),
         customeRoles("assets/user.svg", "Consultant", () { 
          Navigator.pushNamed(context, RoutesName.ConsultantSignUpScreen);
         }),
         customeRoles("assets/user.svg", "Seller", () { 
                      Navigator.pushNamed(context, RoutesName.SellerSignUpScreen);
         }),
