...
class ConsultantChatMassageScreen extends StatefulWidget {
  @override
  _ConsultantChatMassageScreenState createState() => _ConsultantChatMassageScreenState();
}

class _ConsultantChatMassageScreenState extends State<ConsultantChatMassageScreen> {
