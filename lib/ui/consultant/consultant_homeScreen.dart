                    ...
                    Padding(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                            border:
                                Border.all(color: colorLight3.withOpacity(.2)),
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(item[index].createdAt!.substring(14,19).toString()),
                              ),
                            ],
                          ),
                        );
