...
class ConsultantBottomNavigationBarScreen extends StatefulWidget {
  const ConsultantBottomNavigationBarScreen({super.key});

  @override
  State<ConsultantBottomNavigationBarScreen> createState() =>
